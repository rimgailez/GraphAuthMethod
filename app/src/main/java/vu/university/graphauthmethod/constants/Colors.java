package vu.university.graphauthmethod.constants;

import android.graphics.Color;

public final class Colors {

    public final int[] mainColors = new int[] {Color.rgb(255,0, 0), Color.rgb(255,128,0),
    ...
    public final int[] additionalColors = new int[] {Color.rgb(255,117,163), Color.rgb(215, 175, 250),
            Color.rgb(0, 153, 153), Color.rgb(190, 232, 106),
            Color.rgb(128,128,128), Color.rgb(242, 187, 166),
